...
class TestSearchToolkit:
    ...
    @patch("cogents.toolify.resources.websearch.TavilySearchWrapper")
    async def test_tavily_search_success(self, mock_tavily_wrapper, search_toolkit):
        ...
        # Mock search result
        from cogents.toolify.resources.websearch.types import SearchResult, SourceItem
    ...
    @patch("cogents.toolify.resources.websearch.GoogleAISearch")
    ...
    async def test_tavily_search_depth_options(self, search_depth, search_toolkit):
        ...
        with patch("cogents.toolify.resources.websearch.TavilySearchWrapper") as mock_wrapper:
            mock_instance = Mock()  # Use regular Mock, not AsyncMock
            mock_wrapper.return_value = mock_instance

            from cogents.toolify.resources.websearch.types import SearchResult
    ...
    async def test_google_ai_search_model_options(self, model, search_toolkit):
        ...
        with patch("cogents.toolify.resources.websearch.GoogleAISearch") as mock_google:
            mock_instance = Mock()  # Use regular Mock, not AsyncMock
