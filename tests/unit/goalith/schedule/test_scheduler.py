...
from cogents.goalith.base.priority_policy import PriorityOrder
...
class TestScheduler:
    ...
    def test_complex_scheduling_scenario(self):
        ...
        nodes = [
            GoalNode(description="High priority urgent", priority=9.0, 
                    deadline=now + timedelta(hours=1)),
            GoalNode(description="Low priority not urgent", priority=2.0, 
                    deadline=now + timedelta(days=7)),
            GoalNode(description="Medium priority", priority=5.0),
            GoalNode(description="High priority not urgent", priority=8.0, 
